...
export const getAllUsers=async(req,res)=>{
    try {
        let users = await UserModel.find().select('username email updatedAt createdAt')
        ...
        console.log("on GetAllUsers",error.message)
    }
...
export const updateUser = async(req,res)=>{
   try {
    ...
    const newUpdate = {...req.body,profile:req.body.profile,about:req.body.about,updatedAt:Date.now}
...
export const addFollower = async (req,res)=>{
        try {
         ...
         console.log("on addFollower",error.message,req.body)
        }
}
...
export const removeFollower = async (req,res)=>{
 ...
 const result = await UserModel.findByIdAndUpdate(unfollowId,{
  ...
  },{new:true}).populate('following','_id username')
               .populate('followers','_id username')
               .exec()
               result.hashed_password = undefined
               result.salt=undefined
